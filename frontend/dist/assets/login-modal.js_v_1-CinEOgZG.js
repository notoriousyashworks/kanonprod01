(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}})();const F="kicksaura_wishlist";function $(){const e=localStorage.getItem(F);return e?JSON.parse(e):[]}function ae(e){localStorage.setItem(F,JSON.stringify(e))}function R(e){return $().some(n=>n.id===e)}function K(e){var s,r,a,l,d,c;let t=e;if(typeof e=="string"&&(t=(s=window._allProducts)==null?void 0:s.find(p=>p.id===e),!t)){const p=document.querySelector(`[data-product-id="${e}"]`);p?t={id:e,name:((r=p.querySelector(".pc-name"))==null?void 0:r.textContent)||"Product",imageUrls:[(a=p.querySelector("img"))==null?void 0:a.src],discountedPrice:parseFloat(((d=(l=p.querySelector(".pc-price"))==null?void 0:l.textContent)==null?void 0:d.replace(/[^0-9.]/g,""))||"0")}:t={id:e}}let n=$();const o=n.findIndex(p=>p.id===t.id);let i=!1;return o>-1?n.splice(o,1):(n.push({id:t.id,name:t.name,image:((c=t.imageUrls)==null?void 0:c[0])||"/images/products/redjordanface1.png",price:t.discountedPrice||t.basePrice,originalPrice:t.discountedPrice?t.basePrice:null}),i=!0),ae(n),le(),J(),i?D("Added to wishlist!","success"):D("Removed from wishlist.","info"),i}function le(){const e=$(),t=document.getElementById("wishlist-badge");t&&(t.textContent=e.length,t.style.display=e.length>0?"flex":"none")}function J(){const e=document.getElementById("wishlist-items-container");if(!e)return;const t=$();if(t.length===0){e.innerHTML=`
...
`,pe="/api/v1";async function u(e,t={}){const n=`${pe}${e}`,o={headers:{"Content-Type":"application/json",...t.headers},credentials:"include",...t};try{const i=await fetch(n,o);if(!i.ok){if(i.status===401)throw console.warn("Session expired or unauthorized. Logging out..."),ee(),new Error("Session expired. Please log in again.");const s=await i.json().catch(()=>({}));throw new Error(s.error||`Request failed with status ${i.status}`)}return i.status===204?null:await i.json()}catch(i){throw console.error(`API Error [${e}]:`,i),i}}async function Ve(){return u("/categories")}async function We(){const e=await u("/products");return e.content||e}async function Ue(){const e=await u("/products/new-arrivals");return e.content||e}async function Fe(){const e=await u("/products/trending");return e.content||e}async function Re(e,t=0,n=16){const o=new URLSearchParams;e.query&&o.append("query",e.query),e.categories&&e.categories.length>0&&o.append("categories",e.categories.join(",")),e.brands&&e.brands.length>0&&o.append("brands",e.brands.join(",")),e.minPrice!==void 0&&e.minPrice>0&&o.append("minPrice",e.minPrice),e.maxPrice!==void 0&&e.maxPrice<35e3&&o.append("maxPrice",e.maxPrice),e.sizes&&e.sizes.length>0&&o.append("sizes",e.sizes.join(",")),o.append("page",t),o.append("size",n);const s=`/products/filter?${o.toString()}`;return u(s)}async function Ke(e){return u(`/products/${e}`)}async function Je(e,t,n=8){const o=await u(`/products/category/${encodeURIComponent(e)}`),s=(o.content||o).filter(r=>String(r.id)!==String(t));for(let r=s.length-1;r>0;r--){const a=Math.floor(Math.random()*(r+1));[s[r],s[a]]=[s[a],s[r]]}return s.slice(0,n)}async function Ye(){return u("/brands")}async function Ge(e){return u("/orders/checkout",{method:"POST",body:JSON.stringify(e)})}async function Qe(e){return u(`/orders/user/${e}?t=${Date.now()}`)}async function Ze(){return u("/reviews")}async function Xe(e){return u("/users/profile",{method:"PUT",body:JSON.stringify(e)})}async function et(e){return u("/users/profile/address",{method:"POST",body:JSON.stringify(e)})}function D(e,t="info"){let n=document.querySelector(".toast-container");n||(n=document.createElement("div"),n.className="toast-container",document.body.appendChild(n));const o=n.querySelectorAll(".toast");for(let s of o)if(s.textContent===e)return;const i=document.createElement("div");i.className=`toast toast--${t}`,i.textContent=e,n.appendChild(i),setTimeout(()=>{i.remove()},3e3)}function tt(){const e=document.getElementById("nav-search-input"),t=document.getElementById("nav-search-btn"),n=()=>{e&&e.value.trim()&&(window.location.href=`/products?search=${encodeURIComponent(e.value.trim())}`)};e&&e.addEventListener("keydown",r=>{r.key==="Enter"&&n()}),t&&t.addEventListener("click",n);const o=document.getElementById("nav-animated-placeholder"),i=document.getElementById("placeholder-text-1"),s=document.getElementById("placeholder-text-2");if(e&&o&&i&&s){const r=["Search for Sneakers...","Search for Apparel...","Search for Perfumes...","Search for Watches...","Search for Nike Pandas...","Search for Adidas Sambas...","Search for New Balance 9060...","Search for Air Force 1...","Search for Onitsuka Tiger...","Search for Air Jordan 1...","Search for Sunglasses...","Search for Nike Dunks...","Search for Adidas Campus...","Search for Belts...","Search for New Balance 530...","Search for Air Jordan 4...","Search for Adidas Spezial...","Search for Nike Vomero...","Search for Wallets...","Search for ASICS Gel-NYC...","Search for Nike P-6000...","Search for New Balance 550...","Search for Travis Scott...","Search for Accessories...","Search for Yeezy 350..."];let a=0,l=0,d=!1,c=null;const p=()=>{const M=r[a];d?(i.textContent=M.substring(0,l-1),l--):(i.textContent=M.substring(0,l+1),l++);let N=d?30:60;!d&&l===M.length?(N=2e3,d=!0):d&&l===0&&(d=!1,a=(a+1)%r.length,N=500),c=setTimeout(p,N)},E=()=>{c||(s&&(s.style.display="none"),i.className="animated-placeholder-text visible",c=setTimeout(p,500))},I=()=>{c&&(clearTimeout(c),c=null)},m=()=>{document.activeElement===e||e.value.trim()!==""?(o.style.display="none",I()):(o.style.display="flex",E())};e.addEventListener("focus",m),e.addEventListener("blur",m),e.addEventListener("input",m),m()}}function ue(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.includes("/upload/")&&!e.includes("/f_auto")?e.replace("/upload/","/upload/f_auto,q_auto,w_800/"):e}function ge(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/so_0,w_800,q_auto/f_jpg/")}function fe(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/sp_auto:maxres_720p/").replace(/\.mp4$/i,".m3u8")}function me(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/q_auto,vc_h264,w_800/")}function he(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/q_auto,vc_h264,w_400/")}function g(e){return typeof e=="string"&&e.includes("ik.imagekit.io")}function ve(e){return!g(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=q-auto,f-auto,w-800"}function ye(e){return!g(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=orig"}function be(e){return!g(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=orig"}function we(e){return!g(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=orig"}function xe(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?ue(e):g(e)?ve(e):e}function ke(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?ge(e):g(e)?ye(e):e}function nt(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?fe(e):(g(e),e)}function it(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?me(e):g(e)?be(e):e}function Ee(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?he(e):g(e)?we(e):e}function Ie(e,t){const n="916239379751",o=`I am interested in ${e} - ${window.location.origin}/product-details?id=${t}`,i=`https://wa.me/${n}?text=${encodeURIComponent(o)}`;window.open(i,"_blank","noopener,noreferrer")}typeof window<"u"&&(window.openProductWhatsApp=Ie);function ot(e){var E,I;const t=xe(((E=e.imageUrls)==null?void 0:E[0])||""),o=((I=e.videoUrls)==null?void 0:I.length)>0?e.videoUrls[0]:null,i=m=>"₹"+m.toLocaleString("en-IN"),s=e.discountedPrice||e.basePrice,r=e.discountedPrice?e.basePrice:null,a=R(e.id),l=r?Math.round((r-s)/r*100):0;let d="";t?d=`<img src="${t}" alt="${e.name}" loading="lazy" />`:o?d=`<video 
    ...
    </video>`:d='<div class="pc-no-image">👟</div>';const c="";(e.name||"").replace(/"/g,"&quot;");const p=(e.category||"").trim().toLowerCase()==="handbags";return`
      ...
      <article class="product-card product-card-new ${p?"is-handbag":""}" data-product-id="${e.id}">
        ...
        <div class="pc-body">
          ...
          <div class="pc-price-row">
            ...
            ${l>0?`<span class="pc-savings-badge">-${l}%</span>`:""}
          </div>
        </div>
      </article>
    </a>
      ...
      <div class="header__banner" id="header-banner">
        <div class="header__banner-ticker" id="header-ticker">
          <div class="ticker-item is-active">
            <span class="ticker-highlight">Complimentary Shipping</span>
            <span class="ticker-divider">|</span>
            <span>Prepaid orders · Use code <strong>GRAB100</strong> for ₹100 off</span>
          </div>
          <div class="ticker-item">
            <span class="ticker-highlight">COD Available Pan India</span>
            <span class="ticker-divider">|</span>
            <span>Only ₹99 advance · Delivered in 4–5 days</span>
          </div>
          <div class="ticker-item">
            <span class="ticker-highlight">Prepaid Bonus</span>
            <span class="ticker-divider">|</span>
            <span>Extra ₹200 off on all prepaid orders</span>
          </div>
          <div class="ticker-item">
            <span class="ticker-highlight">1000+ Happy Customers</span>
            <span class="ticker-divider">|</span>
            <span>Across India · Verified quality every order</span>
          </div>
        </div>
      </div>
    </header>
    ...
    <div class="trust-strip">
      <div class="trust-strip__inner">
        <div class="trust-strip__item">
          ...
          <div class="trust-strip__label">100% Quality Checked</div>
          <div class="trust-strip__sub">Every product verified before dispatch</div>
        </div>
        <div class="trust-strip__item">
          <div class="trust-strip__icon">
          ...
          <div class="trust-strip__label">Discreet Express Shipping</div>
          <div class="trust-strip__sub">Pan India delivery in 4–5 days</div>
        </div>
        <div class="trust-strip__item">
          <div class="trust-strip__icon">
        ...
        <div class="trust-strip__item">
          ...
          <div class="trust-strip__label">Secure Checkout</div>
          <div class="trust-strip__sub">SSL encrypted · COD available</div>
        </div>
      </div>
    </div>
    <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="footer__bottom">
          <span class="footer__bottom-copy">© 2025 Kicks Aura. All rights reserved.</span>
          <div class="footer__bottom-links">
            <a href="/privacy-policy">Privacy Policy</a>
            <a href="/terms-conditions">Terms</a>
            <a href="/return-exchange">Returns</a>
          </div>
        </div>
      </div>
    </footer>
  `}function _e(){const e=document.getElementById("footer-container");e&&(e.innerHTML=Se())}function rt(){const e=document.getElementById("header-ticker");if(!e)return;const t=e.querySelectorAll(".ticker-item");if(!t.length)return;let n=0;setInterval(()=>{const o=t[n];o.classList.add("is-leaving"),o.classList.remove("is-active"),n=(n+1)%t.length;const i=t[n];i.classList.remove("is-leaving"),i.classList.add("is-active"),setTimeout(()=>{o.classList.remove("is-leaving")},600)},3800)}function at(){const e=document.getElementById("mobile-menu-btn"),t=document.getElementById("mobile-nav-drawer"),n=document.getElementById("mobile-nav-overlay"),o=document.getElementById("mobile-nav-close");if(!e||!t||!n)return;const i=()=>{t.classList.add("is-open"),n.classList.add("is-open"),e.setAttribute("aria-expanded","true"),document.body.style.overflow="hidden"},s=()=>{t.classList.remove("is-open"),n.classList.remove("is-open"),e.setAttribute("aria-expanded","false"),document.body.style.overflow=""};e.addEventListener("click",i),o&&o.addEventListener("click",s),n.addEventListener("click",s),t.querySelectorAll(".mobile-nav-link").forEach(r=>{r.addEventListener("click",s)})}function V(){_e()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",V):V();const A="kicksaura_cart";function Ce(e,t){if(e==null&&t==null)return!0;if(e==null||t==null){const n=String(e??"").trim(),o=String(t??"").trim();return(n===""||n==="null"||n==="undefined")&&(o===""||o==="null"||o==="undefined")}return String(e).trim()===String(t).trim()}function O(e,t,n){return!(!Ce(e.productId,t)||String(e.size).trim()!==String(n).trim())}function Le(e){if(!Array.isArray(e)||e.length<=1)return e||[];const t=[];for(const n of e){const o=t.find(i=>O(i,n.productId,n.size));o?(o.quantity=(Number(o.quantity)||1)+(Number(n.quantity)||1),o.liveVideoCall=!!o.liveVideoCall||!!n.liveVideoCall,o.variantId=n.variantId||o.variantId):t.push({...n,quantity:Number(n.quantity)||1})}return t}function y(){const e=localStorage.getItem(A),t=e?JSON.parse(e):[],n=Le(t);return t.length!==n.length&&e&&localStorage.setItem(A,JSON.stringify(n)),n}function j(e){localStorage.setItem(A,JSON.stringify(e)),te(),window.dispatchEvent(new CustomEvent("cart-updated",{detail:e}))}function lt(e,t,n=1,o={}){var l;const i=y(),s=(t==null?void 0:t.size)||"",r=!!o.liveVideoCall,a=i.findIndex(d=>O(d,e.id,s));if(a>-1){const d=(Number(i[a].quantity)||1)+(Number(n)||1);d>10?(alert("You can't add more than 10 items of the same product."),i[a].quantity=10):i[a].quantity=d,i[a].liveVideoCall=!!i[a].liveVideoCall||r,i[a].variantId=t&&t.id?t.id:i[a].variantId}else{const d=Number(n)||1;d>10&&alert("You can't add more than 10 items of the same product."),i.push({productId:e.id,variantId:t&&t.id||null,productName:e.name,productBrand:e.brand,productImage:((l=e.imageUrls)==null?void 0:l[0])||"",size:s,price:e.discountedPrice||e.basePrice,basePrice:e.basePrice,quantity:Math.min(10,d),liveVideoCall:!!o.liveVideoCall})}return j(i),i}function dt(e,t){let n=y();return n=n.filter(o=>!O(o,e,t)),j(n),n}function ct(e,t,n){const o=y(),i=o.find(s=>O(s,e,t));if(i){const s=Number(n)||1;s>10?(alert("You can't add more than 10 items of the same product."),i.quantity=10):i.quantity=Math.max(1,s)}return j(o),o}function pt(){return y()}function ut(){return y().reduce((e,t)=>e+t.price*t.quantity,0)}function Pe(){return y().reduce((e,t)=>e+t.quantity,0)}function gt(){localStorage.removeItem(A),te(),window.dispatchEvent(new CustomEvent("cart-updated",{detail:[]}))}function te(){const e=document.querySelectorAll(".navbar__cart-count"),t=Pe();e.forEach(n=>{n.textContent=t,n.style.display=t>0?"flex":"none"})}const Be="https://verify.msg91.com/otp-provider.js",z=4,ne=30;let W=!1,S=!1,_=null,ie="",T=null,C=null;async function Ae(){if(_)return _;try{const e=await fetch("/api/v1/users/auth/widget-config");if(!e.ok){const t=await e.text().catch(()=>"no body");throw new Error(`HTTP ${e.status}: ${t}`)}return _=await e.json(),_}catch(e){throw console.error("[KicksAura] Could not load MSG91 widget config:",e.message),new Error("API Error: "+e.message)}}function Te(){return new Promise((e,t)=>{if(window.initSendOTP){e();return}if(S){const i=setInterval(()=>{window.initSendOTP&&(clearInterval(i),e())},100);setTimeout(()=>{clearInterval(i),t(new Error("SDK load timeout"))},1e4);return}S=!0;const n=document.getElementById("msg91-otp-sdk");n&&n.remove();const o=document.createElement("script");o.id="msg91-otp-sdk",o.src=Be,o.onload=()=>{const i=setInterval(()=>{window.initSendOTP&&(clearInterval(i),S=!1,e())},50);setTimeout(()=>{clearInterval(i),t(new Error("initSendOTP unavailable"))},8e3)},o.onerror=()=>{S=!1,t(new Error("Failed to load MSG91 SDK"))},document.head.appendChild(o)})}function $e(e){W||(window.initSendOTP({widgetId:e.widgetId,tokenAuth:e.widgetToken,exposeMethods:!0,success:t=>{},failure:t=>console.error("MSG91 Init Failure:",t)}),W=!0)}function Oe(e=null){let t=document.getElementById("login-modal-overlay");t||(t=document.createElement("div"),t.id="login-modal-overlay",t.className="login-modal-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Log in to KicksAura"),document.body.appendChild(t)),t.classList.add("checkout-mode");const n=`
      <!-- PHONE STEP -->
  ...
  `,!document.getElementById("policy-modal-overlay")){const r=document.createElement("div");r.id="policy-modal-overlay",r.className="login-modal-overlay",r.style.zIndex="99999",r.innerHTML=`
    ...
    `,document.body.appendChild(r),document.getElementById("policy-modal-close").addEventListener("click",()=>{document.getElementById("policy-modal-overlay").classList.remove("open")}),r.addEventListener("click",a=>{a.target===r&&r.classList.remove("open")})}Me();const i=document.getElementById("login-about-link");i&&(i.onclick=r=>{r.preventDefault(),document.getElementById("policy-modal-title").textContent="About Us",document.getElementById("policy-modal-content").innerHTML=de,document.getElementById("policy-modal-overlay").classList.add("open")});const s=document.getElementById("login-shipping-link");s&&(s.onclick=r=>{r.preventDefault(),document.getElementById("policy-modal-title").textContent="Shipping & Delivery Policy",document.getElementById("policy-modal-content").innerHTML=ce,document.getElementById("policy-modal-overlay").classList.add("open")})}function Me(){document.getElementById("login-modal-close").addEventListener("click",P),document.getElementById("login-modal-overlay").addEventListener("click",n=>{n.target===document.getElementById("login-modal-overlay")&&P()}),document.addEventListener("keydown",n=>{n.key==="Escape"&&P()}),document.getElementById("login-send-otp-btn").addEventListener("click",U);const e=document.getElementById("login-phone-input");function t(){const n=document.getElementById("login-phone-display");if(!n)return;const o=e.value.replace(/\D/g,"").slice(0,10);let i="";for(let s=0;s<10;s++){const r=o[s]||"",a=s===o.length,l=s===4?"margin-right: 12px;":"",c=a&&document.activeElement===e?"border-bottom: 2px solid #0f172a;":"border-bottom: 2px solid #cbd5e1;";i+=`<span style="width: 14px; height: 28px; display: inline-flex; justify-content: center; align-items: center; font-size: 18px; font-weight: 600; color: ${r?"#0f172a":"transparent"}; ${c} ${l} transition: all 0.2s;">${r||"0"}</span>`}n.innerHTML=i}e.addEventListener("keydown",n=>{n.key==="Enter"&&U()}),e.addEventListener("input",n=>{let o=n.target.value.replace(/\D/g,"");o.length>10&&(o=o.slice(0,10)),n.target.value=o,t(),re()}),e.addEventListener("focus",t),e.addEventListener("blur",t),t(),Ne(),document.getElementById("login-verify-btn").addEventListener("click",L),document.getElementById("login-resend-btn").addEventListener("click",ze),document.getElementById("login-change-phone-btn").addEventListener("click",()=>{oe()})}function Ne(){const e=k();e.forEach((t,n)=>{t.addEventListener("input",o=>{const i=o.target.value.replace(/\D/g,"");o.target.value=i.slice(-1),i?(t.classList.add("filled"),t.classList.remove("error"),n<e.length-1?e[n+1].focus():Array.from(e).every(r=>r.value)&&L()):t.classList.remove("filled"),v()}),t.addEventListener("keydown",o=>{o.key==="Backspace"?!t.value&&n>0&&(e[n-1].value="",e[n-1].classList.remove("filled"),e[n-1].focus()):o.key==="Enter"&&L()}),t.addEventListener("paste",o=>{o.preventDefault();const i=(o.clipboardData||window.clipboardData).getData("text").replace(/\D/g,"");if(!i)return;e.forEach((r,a)=>{r.value=i[a]||"",i[a]?r.classList.add("filled"):r.classList.remove("filled")});const s=e.findIndex(r=>!r.value);s===-1?(e[e.length-1].focus(),L()):e[s].focus(),v()})})}function k(){return Array.from({length:z},(e,t)=>document.getElementById(`otp-box-${t}`))}function qe(){return k().map(e=>e.value).join("")}function H(){k().forEach(e=>{e.value="",e.classList.remove("filled","error")})}function oe(){x(),document.getElementById("login-step-phone").style.display="",document.getElementById("login-step-otp").style.display="none";const e=document.getElementById("login-modal-title"),t=document.getElementById("login-modal-subtitle");e&&(e.textContent="Log In"),t&&(t.textContent="Enter your mobile number to continue");const n=document.getElementById("login-phone-input");n&&(n.value=""),H(),v(),b(!1),setTimeout(()=>{var o;return(o=document.getElementById("login-phone-input"))==null?void 0:o.focus()},50)}function je(){document.getElementById("login-step-phone").style.display="none",document.getElementById("login-step-otp").style.display="";const e=document.getElementById("login-modal-title"),t=document.getElementById("login-modal-subtitle");e&&(e.textContent="Enter OTP"),t&&(t.textContent="Check your SMS"),document.getElementById("login-otp-phone-display").textContent=`+91 ${ie}`,H(),v(),h(!1),se(),setTimeout(()=>{var n;return(n=document.getElementById("otp-box-0"))==null?void 0:n.focus()},50)}async function U(){const e=document.getElementById("login-phone-input").value.trim().replace(/\D/g,"");if(!e||e.length!==10||!/^[6-9]/.test(e)){q("Please enter a valid 10-digit Indian mobile number.");return}b(!0),re();try{const t=await Ae();await Te(),$e(t);let n=50;for(;typeof window.sendOtp!="function"&&n>0;)await new Promise(i=>setTimeout(i,100)),n--;if(typeof window.sendOtp!="function")throw new Error("MSG91 SDK not ready. Please refresh and try again.");const o="91"+e;ie=e,window.sendOtp(o,i=>{T=(i==null?void 0:i.reqId)||(i==null?void 0:i.message)||null,je(),b(!1)},i=>{const s=typeof i=="string"?i:(i==null?void 0:i.message)||"Could not send OTP. Please try again.";q(s),b(!1)})}catch(t){q(t.message||"Could not send OTP. Please try again."),b(!1)}}async function L(){const e=qe();if(e.length!==z){f("Please enter all 6 digits.");return}if(!T){f("Session expired. Please resend the OTP.");return}h(!0),v(),window.verifyOtp(e,async t=>{try{const n=(t==null?void 0:t.access_token)||(t==null?void 0:t.token)||(t==null?void 0:t.message);if(!n||n.toLowerCase()==="success"){f("Verification error. Please try again."),h(!1);return}const o=await X(n);h(!1),x(),P(),window.dispatchEvent(new CustomEvent("auth-changed",{detail:{loggedIn:!0,user:o}})),w&&(window.location.href=w);const i=document.getElementById("profile-dropdown-name");if(i){const s=[o.firstName,o.lastName].filter(Boolean).join(" ").trim()||`+91 ${o.phoneNumber}`;i.textContent=s}}catch(n){f(n.message||"Login failed. Please try again."),h(!1)}},t=>{const o=(typeof t=="string"?t:(t==null?void 0:t.message)||"Incorrect OTP. Please try again.").toLowerCase().includes("expired")?"OTP has expired. Please resend.":"Incorrect OTP. Please try again.";f(o);const i=k();i.forEach(s=>{s.classList.add("error"),s.value=""}),i[0]&&i[0].focus(),h(!1)},T)}function ze(){const e=document.getElementById("login-resend-btn");if(!e.disabled){e.disabled=!0,v(),H();try{const t=window.retryOTP||window.retryOtp;if(typeof t!="function")throw new Error("OTP service is currently unavailable.");t("11",n=>{n!=null&&n.reqId&&(T=n.reqId),se()},n=>{const o=typeof n=="string"?n:(n==null?void 0:n.message)||"Could not resend OTP. Please try again.";f(o),e.disabled=!1})}catch(t){f(t.message||"An error occurred while resending OTP."),e.disabled=!1}}}function se(){x();let e=ne;const t=document.getElementById("login-countdown-num"),n=document.getElementById("login-resend-countdown"),o=document.getElementById("login-resend-btn");!t||!o||(o.disabled=!0,n&&(n.style.display=""),t.textContent=e,C=setInterval(()=>{e--,t.textContent=e,e<=0&&(x(),o.disabled=!1,n&&(n.style.display="none"))},1e3))}function x(){C&&(clearInterval(C),C=null)}function q(e){var n;const t=document.getElementById("login-phone-error");t&&(t.textContent=e),(n=document.getElementById("login-phone-wrap"))==null||n.classList.add("error")}function re(){var t;const e=document.getElementById("login-phone-error");e&&(e.textContent=""),(t=document.getElementById("login-phone-wrap"))==null||t.classList.remove("error")}function f(e){const t=document.getElementById("login-otp-error");t&&(t.textContent=e)}function v(){const e=document.getElementById("login-otp-error");e&&(e.textContent=""),k().forEach(t=>t.classList.remove("error"))}function b(e){const t=document.getElementById("login-send-otp-btn");t&&(t.disabled=e,t.innerHTML=e?'<span class="login-spinner"></span><span>Sending…</span>':'<span id="login-send-otp-text">Continue</span>')}function h(e){const t=document.getElementById("login-verify-btn");t&&(t.disabled=e,t.innerHTML=e?'<span class="login-spinner"></span><span>Verifying…</span>':'<span id="login-verify-text">Verify OTP</span>')}let w=null;function ft(e=null){let t=null;typeof e=="string"?w=e:e&&typeof e=="object"?(w=e.redirectUrl||null,t=e.context||null):w=null,Oe(t);const n=document.getElementById("login-modal-overlay");if(n){if(t==="checkout"){const o=document.getElementById("login-modal-cart-list");if(o)try{const i=localStorage.getItem("kicksaura_cart"),s=i?JSON.parse(i):[];if(s.length===0)o.innerHTML='<p style="color:#888; font-size:14px;">Your cart is empty.</p>';else{o.innerHTML=s.map(l=>{const d=l.productImage&&l.productImage.startsWith("http")?l.productImage:l.productImage?`https://res.cloudinary.com/undefined/image/upload/w_200,h_200,c_fill,q_auto,f_auto/${l.productImage}`:"",c=(l.price*l.quantity).toLocaleString("en-IN");return`
          ...
          `,o.onclick=l=>{const d=document.getElementById("login-modal-cart-summary");d&&(d.style.display=d.style.display==="none"?"block":"none")}}}catch(i){console.error("Failed to load cart for login modal",i)}}oe(),n.classList.add("open"),document.body.style.overflow="hidden"}}function P(){x();const e=document.getElementById("login-modal-overlay");e&&(e.classList.remove("open"),document.body.style.overflow="",e.classList.contains("checkout-mode")&&(Z()||(window.location.href="/")))}export{D as A,lt as B,Ke as C,xe as D,R as E,ke as F,nt as G,it as H,Je as I,ge as J,fe as K,me as L,K as M,Re as N,We as O,Ye as P,ee as Q,Xe as R,ft as S,Qe as T,Pe as U,ut as V,De as W,de as a,pt as b,Ge as c,et as d,G as e,gt as f,Y as g,ue as h,Z as i,te as j,st as k,X as l,Se as m,at as n,He as o,le as p,tt as q,dt as r,ce as s,rt as t,ct as u,Ze as v,Ve as w,Ue as x,Fe as y,ot as z};
