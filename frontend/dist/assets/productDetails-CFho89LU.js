import{k as re,m as ce,n as de,j as Y,o as pe,p as Z,q as ue,C as he,D as ye,E as N,B as O,A as W,F as me,G as ge,H as ve,I as fe,z as be,J as we,K as ke,L as xe,M as Ee}from"./login-modal.js_v_1-CinEOgZG.js";/* empty css                     */import{i as Le,a as Ue,o as Se}from"./cart-sidebar-CPu_dLYQ.js";import{i as Ie}from"./profile-DXOgewGM.js";document.getElementById("navbar-container").innerHTML=re("product");document.getElementById("footer-container").innerHTML=ce();de();Y();pe();Le();Z();Ie();ue();Ue();const G=e=>e!=null?"₹"+e.toLocaleString("en-IN"):"";async function Ke(){const d=new URLSearchParams(window.location.search).get("id");if(!d){Q("No product ID specified in the URL.");return}try{const h=await he(d);$e(h)}catch(h){console.error("Failed to load product:",h),Q("Could not load product. Please try again.")}}function Q(e){document.getElementById("product-container").innerHTML=`
  ...
  `,ze(e);let v=0;function U(t){v=t;const i=o[v],s=document.getElementById("img-lightbox"),p=document.getElementById("lightbox-content");if(!s||!p||!i)return;const c=document.querySelector(`.main-media-slide[data-idx="${I}"] video`);c&&c.pause(),p.innerHTML=i.type==="video"?`<div style="position: relative; display: flex; align-items: center; justify-content: center; width: 100%; height: 100%;">
           <video 
             poster="${we(i.url)}"
