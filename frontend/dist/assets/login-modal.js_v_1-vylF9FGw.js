...
`,ue="/api/v1";async function u(e,t={}){const n=`${ue}${e}`,o={headers:{"Content-Type":"application/json",...t.headers},credentials:"include",...t};try{const i=await fetch(n,o);if(!i.ok){if(i.status===401)throw console.warn("Session expired or unauthorized. Logging out..."),ee(),new Error("Session expired. Please log in again.");const s=await i.json().catch(()=>({}));throw new Error(s.error||`Request failed with status ${i.status}`)}return i.status===204?null:await i.json()}catch(i){throw console.error(`API Error [${e}]:`,i),i}}async function fe(){return u("/categories")}async function Ue(){const e=await u("/products/new-arrivals");return e.content||e}async function Re(){const e=await u("/products/trending");return e.content||e}async function ge(e,t=0,n=16){const o=new URLSearchParams;e.query&&o.append("query",e.query),e.categories&&e.categories.length>0&&o.append("categories",e.categories.join(",")),e.brands&&e.brands.length>0&&o.append("brands",e.brands.join(",")),e.minPrice!==void 0&&e.minPrice>0&&o.append("minPrice",e.minPrice),e.maxPrice!==void 0&&e.maxPrice<35e3&&o.append("maxPrice",e.maxPrice),e.sizes&&e.sizes.length>0&&o.append("sizes",e.sizes.join(",")),o.append("page",t),o.append("size",n);const s=`/products/filter?${o.toString()}`;return u(s)}async function Ke(e){return u(`/products/${e}`)}async function Je(e,t,n=8){const o=await ge({categories:[e]},0,n+2),s=(o.content||o||[]).filter(r=>String(r.id)!==String(t));for(let r=s.length-1;r>0;r--){const a=Math.floor(Math.random()*(r+1));[s[r],s[a]]=[s[a],s[r]]}return s.slice(0,n)}async function Ye(){return u("/brands")}async function Ge(e){return u("/orders/checkout",{method:"POST",body:JSON.stringify(e)})}async function Qe(e){return u(`/orders/user/${e}?t=${Date.now()}`)}async function Xe(e){return u("/users/profile",{method:"PUT",body:JSON.stringify(e)})}async function Ze(e){return u("/users/profile/address",{method:"POST",body:JSON.stringify(e)})}function D(e,t="info"){let n=document.querySelector(".toast-container");n||(n=document.createElement("div"),n.className="toast-container",document.body.appendChild(n));const o=n.querySelectorAll(".toast");for(let s of o)if(s.textContent===e)return;const i=document.createElement("div");i.className=`toast toast--${t}`,i.textContent=e,n.appendChild(i),setTimeout(()=>{i.remove()},3e3)}function et(){const e=document.getElementById("nav-search-input"),t=document.getElementById("nav-search-btn"),n=()=>{e&&e.value.trim()&&(window.location.href=`/products?search=${encodeURIComponent(e.value.trim())}`)};e&&e.addEventListener("keydown",r=>{r.key==="Enter"&&n()}),t&&t.addEventListener("click",n);const o=document.getElementById("nav-animated-placeholder"),i=document.getElementById("placeholder-text-1"),s=document.getElementById("placeholder-text-2");if(e&&o&&i&&s){const r=["Search for Sneakers...","Search for Apparel...","Search for Perfumes...","Search for Watches...","Search for Nike Pandas...","Search for Adidas Sambas...","Search for New Balance 9060...","Search for Air Force 1...","Search for Onitsuka Tiger...","Search for Air Jordan 1...","Search for Sunglasses...","Search for Nike Dunks...","Search for Adidas Campus...","Search for Belts...","Search for New Balance 530...","Search for Air Jordan 4...","Search for Adidas Spezial...","Search for Nike Vomero...","Search for Wallets...","Search for ASICS Gel-NYC...","Search for Nike P-6000...","Search for New Balance 550...","Search for Travis Scott...","Search for Accessories...","Search for Yeezy 350..."];let a=0,l=0,d=!1,c=null;const p=()=>{const M=r[a];d?(i.textContent=M.substring(0,l-1),l--):(i.textContent=M.substring(0,l+1),l++);let N=d?30:60;!d&&l===M.length?(N=2e3,d=!0):d&&l===0&&(d=!1,a=(a+1)%r.length,N=500),c=setTimeout(p,N)},E=()=>{c||(s&&(s.style.display="none"),i.className="animated-placeholder-text visible",c=setTimeout(p,500))},I=()=>{c&&(clearTimeout(c),c=null)},m=()=>{document.activeElement===e||e.value.trim()!==""?(o.style.display="none",I()):(o.style.display="flex",E())};e.addEventListener("focus",m),e.addEventListener("blur",m),e.addEventListener("input",m),m()}}function me(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.includes("/upload/")&&!e.includes("/f_auto")?e.replace("/upload/","/upload/f_auto,q_auto,w_800/"):e}function he(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/so_0,w_800,q_auto/f_jpg/")}function ye(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/sp_auto:maxres_720p/").replace(/\.mp4$/i,".m3u8")}function ve(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/q_auto,vc_h264,w_800/")}function be(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/q_auto,vc_h264,w_400/")}function f(e){return typeof e=="string"&&e.includes("ik.imagekit.io")}function we(e){return!f(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=q-auto,f-auto,w-800"}function xe(e){return!f(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=orig"}function ke(e){return!f(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=orig"}function Ee(e){return!f(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=orig"}function Ie(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?me(e):f(e)?we(e):e}function Se(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?he(e):f(e)?xe(e):e.includes(".b-cdn.net")&&e.includes(".m3u8")?e.replace("playlist.m3u8","thumbnail.jpg"):e.includes(".b-cdn.net")?"":e}function tt(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?ye(e):f(e)||e.includes(".b-cdn.net")&&e.includes(".m3u8")?e:e.includes(".b-cdn.net")&&e.includes(".mp4")?null:e}function nt(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?ve(e):f(e)?ke(e):e.includes(".b-cdn.net")&&e.includes(".m3u8")?e.replace("playlist.m3u8","play_720p.mp4"):(e.includes(".b-cdn.net")&&e.includes(".mp4"),e)}function Ce(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?be(e):f(e)?Ee(e):e.includes(".b-cdn.net")&&e.includes(".m3u8")?e.replace("playlist.m3u8","play_480p.mp4"):e}function Le(e,t){const n="916239379751",o=`I am interested in ${e} - ${window.location.origin}/product-details?id=${t}`,i=`https://wa.me/${n}?text=${encodeURIComponent(o)}`;window.open(i,"_blank","noopener,noreferrer")}typeof window<"u"&&(window.openProductWhatsApp=Le);function it(e){var E,I;const t=Ie(((E=e.imageUrls)==null?void 0:E[0])||""),o=((I=e.videoUrls)==null?void 0:I.length)>0?e.videoUrls[0]:null,i=m=>"₹"+m.toLocaleString("en-IN"),s=e.discountedPrice||e.basePrice,r=e.discountedPrice?e.basePrice:null,a=R(e.id);let l="";t?l=`<img src="${t}" alt="${e.name}" loading="lazy" />`:o?l=`<video 
    ...
    <a href="/product-details?id=${e.id}" class="product-card-link" aria-label="${e.name}">
      <article class="product-card product-card-new ${p?"is-handbag":""}" data-product-id="${e.id}">
        <div class="pc-image-wrap">
          ${d}
          <button class="pc-heart-btn ${a?"active":""}" onclick="event.preventDefault(); event.stopPropagation(); toggleWishlistItem('${e.id}'); this.classList.toggle('active'); this.querySelector('svg').setAttribute('fill', this.classList.contains('active') ? '#c82333' : 'none'); this.querySelector('svg').setAttribute('stroke', this.classList.contains('active') ? '#c82333' : 'currentColor')">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="${a?"#c82333":"none"}" stroke="${a?"#c82333":"currentColor"}" stroke-width="2">
  ...
  `}function _e(){const e=document.getElementById("footer-container");e&&(e.innerHTML=Pe())}function st(){const e=document.getElementById("mobile-menu-btn"),t=document.getElementById("mobile-nav-drawer"),n=document.getElementById("mobile-nav-overlay"),o=document.getElementById("mobile-nav-close");if(!e||!t||!n)return;const i=()=>{t.classList.add("is-open"),n.classList.add("is-open"),e.setAttribute("aria-expanded","true"),document.body.style.overflow="hidden"},s=()=>{t.classList.remove("is-open"),n.classList.remove("is-open"),e.setAttribute("aria-expanded","false"),document.body.style.overflow=""};e.addEventListener("click",i),o&&o.addEventListener("click",s),n.addEventListener("click",s),t.querySelectorAll(".mobile-nav-link").forEach(r=>{r.addEventListener("click",s)})}async function te(){const e=document.getElementById("desktop-nav-categories");if(e)try{const t=await fe();if(!t||t.length===0)return;e.innerHTML=t.map(n=>`
      <a href="/products?categories=${encodeURIComponent(n.name)}" class="nav-dropdown-link">${n.name}</a>
    `).join("")}catch(t){console.error("Failed to load categories for dropdown:",t)}}function V(){_e(),te()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",V):V();const A="kicksaura_cart";function Be(e,t){if(e==null&&t==null)return!0;if(e==null||t==null){const n=String(e??"").trim(),o=String(t??"").trim();return(n===""||n==="null"||n==="undefined")&&(o===""||o==="null"||o==="undefined")}return String(e).trim()===String(t).trim()}function O(e,t,n){return!(!Be(e.productId,t)||String(e.size).trim()!==String(n).trim())}function Ae(e){if(!Array.isArray(e)||e.length<=1)return e||[];const t=[];for(const n of e){const o=t.find(i=>O(i,n.productId,n.size));o?(o.quantity=(Number(o.quantity)||1)+(Number(n.quantity)||1),o.liveVideoCall=!!o.liveVideoCall||!!n.liveVideoCall,o.variantId=n.variantId||o.variantId):t.push({...n,quantity:Number(n.quantity)||1})}return t}function v(){const e=localStorage.getItem(A),t=e?JSON.parse(e):[],n=Ae(t);return t.length!==n.length&&e&&localStorage.setItem(A,JSON.stringify(n)),n}function j(e){localStorage.setItem(A,JSON.stringify(e)),ne(),window.dispatchEvent(new CustomEvent("cart-updated",{detail:e}))}function rt(e,t,n=1,o={}){var l;const i=v(),s=(t==null?void 0:t.size)||"",r=!!o.liveVideoCall,a=i.findIndex(d=>O(d,e.id,s));if(a>-1){const d=(Number(i[a].quantity)||1)+(Number(n)||1);d>10?(alert("You can't add more than 10 items of the same product."),i[a].quantity=10):i[a].quantity=d,i[a].liveVideoCall=!!i[a].liveVideoCall||r,i[a].variantId=t&&t.id?t.id:i[a].variantId}else{const d=Number(n)||1;d>10&&alert("You can't add more than 10 items of the same product."),i.push({productId:e.id,variantId:t&&t.id||null,productName:e.name,productBrand:e.brand,productImage:((l=e.imageUrls)==null?void 0:l[0])||"",size:s,price:e.discountedPrice||e.basePrice,basePrice:e.basePrice,quantity:Math.min(10,d),liveVideoCall:!!o.liveVideoCall})}return j(i),i}function at(e,t){let n=v();return n=n.filter(o=>!O(o,e,t)),j(n),n}function lt(e,t,n){const o=v(),i=o.find(s=>O(s,e,t));if(i){const s=Number(n)||1;s>10?(alert("You can't add more than 10 items of the same product."),i.quantity=10):i.quantity=Math.max(1,s)}return j(o),o}function dt(){return v()}function ct(){return v().reduce((e,t)=>e+t.price*t.quantity,0)}function Te(){return v().reduce((e,t)=>e+t.quantity,0)}function pt(){localStorage.removeItem(A),ne(),window.dispatchEvent(new CustomEvent("cart-updated",{detail:[]}))}function ne(){const e=document.querySelectorAll(".navbar__cart-count"),t=Te();e.forEach(n=>{n.textContent=t,n.style.display=t>0?"flex":"none"})}const $e="https://verify.msg91.com/otp-provider.js",z=4,ie=30;let W=!1,S=!1,C=null,oe="",T=null,L=null;async function Oe(){if(C)return C;try{const e=await fetch("/api/v1/users/auth/widget-config");if(!e.ok){const t=await e.text().catch(()=>"no body");throw new Error(`HTTP ${e.status}: ${t}`)}return C=await e.json(),C}catch(e){throw console.error("[KicksAura] Could not load MSG91 widget config:",e.message),new Error("API Error: "+e.message)}}function Me(){return new Promise((e,t)=>{if(window.initSendOTP){e();return}if(S){const i=setInterval(()=>{window.initSendOTP&&(clearInterval(i),e())},100);setTimeout(()=>{clearInterval(i),t(new Error("SDK load timeout"))},1e4);return}S=!0;const n=document.getElementById("msg91-otp-sdk");n&&n.remove();const o=document.createElement("script");o.id="msg91-otp-sdk",o.src=$e,o.onload=()=>{const i=setInterval(()=>{window.initSendOTP&&(clearInterval(i),S=!1,e())},50);setTimeout(()=>{clearInterval(i),t(new Error("initSendOTP unavailable"))},8e3)},o.onerror=()=>{S=!1,t(new Error("Failed to load MSG91 SDK"))},document.head.appendChild(o)})}function Ne(e){W||(window.initSendOTP({widgetId:e.widgetId,tokenAuth:e.widgetToken,exposeMethods:!0,success:t=>{},failure:t=>console.error("MSG91 Init Failure:",t)}),W=!0)}function qe(e=null){let t=document.getElementById("login-modal-overlay");t||(t=document.createElement("div"),t.id="login-modal-overlay",t.className="login-modal-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-label","Log in to KicksAura"),document.body.appendChild(t)),t.classList.add("checkout-mode");const n=`
      <!-- PHONE STEP -->
  ...
  `,!document.getElementById("policy-modal-overlay")){const r=document.createElement("div");r.id="policy-modal-overlay",r.className="login-modal-overlay",r.style.zIndex="99999",r.innerHTML=`
    ...
    `,document.body.appendChild(r),document.getElementById("policy-modal-close").addEventListener("click",()=>{document.getElementById("policy-modal-overlay").classList.remove("open")}),r.addEventListener("click",a=>{a.target===r&&r.classList.remove("open")})}je();const i=document.getElementById("login-about-link");i&&(i.onclick=r=>{r.preventDefault(),document.getElementById("policy-modal-title").textContent="About Us",document.getElementById("policy-modal-content").innerHTML=ce,document.getElementById("policy-modal-overlay").classList.add("open")});const s=document.getElementById("login-shipping-link");s&&(s.onclick=r=>{r.preventDefault(),document.getElementById("policy-modal-title").textContent="Shipping & Delivery Policy",document.getElementById("policy-modal-content").innerHTML=pe,document.getElementById("policy-modal-overlay").classList.add("open")})}function je(){document.getElementById("login-modal-close").addEventListener("click",_),document.getElementById("login-modal-overlay").addEventListener("click",n=>{n.target===document.getElementById("login-modal-overlay")&&_()}),document.addEventListener("keydown",n=>{n.key==="Escape"&&_()}),document.getElementById("login-send-otp-btn").addEventListener("click",F);const e=document.getElementById("login-phone-input");function t(){const n=document.getElementById("login-phone-display");if(!n)return;const o=e.value.replace(/\D/g,"").slice(0,10);let i="";for(let s=0;s<10;s++){const r=o[s]||"",a=s===o.length,l=s===4?"margin-right: 12px;":"",c=a&&document.activeElement===e?"border-bottom: 2px solid #0f172a;":"border-bottom: 2px solid #cbd5e1;";i+=`<span style="width: 14px; height: 28px; display: inline-flex; justify-content: center; align-items: center; font-size: 18px; font-weight: 600; color: ${r?"#0f172a":"transparent"}; ${c} ${l} transition: all 0.2s;">${r||"0"}</span>`}n.innerHTML=i}e.addEventListener("keydown",n=>{n.key==="Enter"&&F()}),e.addEventListener("input",n=>{let o=n.target.value.replace(/\D/g,"");o.length>10&&(o=o.slice(0,10)),n.target.value=o,t(),ae()}),e.addEventListener("focus",t),e.addEventListener("blur",t),t(),ze(),document.getElementById("login-verify-btn").addEventListener("click",P),document.getElementById("login-resend-btn").addEventListener("click",Ve),document.getElementById("login-change-phone-btn").addEventListener("click",()=>{se()})}function ze(){const e=k();e.forEach((t,n)=>{t.addEventListener("input",o=>{const i=o.target.value.replace(/\D/g,"");o.target.value=i.slice(-1),i?(t.classList.add("filled"),t.classList.remove("error"),n<e.length-1?e[n+1].focus():Array.from(e).every(r=>r.value)&&P()):t.classList.remove("filled"),y()}),t.addEventListener("keydown",o=>{o.key==="Backspace"?!t.value&&n>0&&(e[n-1].value="",e[n-1].classList.remove("filled"),e[n-1].focus()):o.key==="Enter"&&P()}),t.addEventListener("paste",o=>{o.preventDefault();const i=(o.clipboardData||window.clipboardData).getData("text").replace(/\D/g,"");if(!i)return;e.forEach((r,a)=>{r.value=i[a]||"",i[a]?r.classList.add("filled"):r.classList.remove("filled")});const s=e.findIndex(r=>!r.value);s===-1?(e[e.length-1].focus(),P()):e[s].focus(),y()})})}function k(){return Array.from({length:z},(e,t)=>document.getElementById(`otp-box-${t}`))}function He(){return k().map(e=>e.value).join("")}function H(){k().forEach(e=>{e.value="",e.classList.remove("filled","error")})}function se(){x(),document.getElementById("login-step-phone").style.display="",document.getElementById("login-step-otp").style.display="none";const e=document.getElementById("login-modal-title"),t=document.getElementById("login-modal-subtitle");e&&(e.textContent="Log In"),t&&(t.textContent="Enter your mobile number to continue");const n=document.getElementById("login-phone-input");n&&(n.value=""),H(),y(),b(!1),setTimeout(()=>{var o;return(o=document.getElementById("login-phone-input"))==null?void 0:o.focus()},50)}function De(){document.getElementById("login-step-phone").style.display="none",document.getElementById("login-step-otp").style.display="";const e=document.getElementById("login-modal-title"),t=document.getElementById("login-modal-subtitle");e&&(e.textContent="Enter OTP"),t&&(t.textContent="Check your SMS"),document.getElementById("login-otp-phone-display").textContent=`+91 ${oe}`,H(),y(),h(!1),re(),setTimeout(()=>{var n;return(n=document.getElementById("otp-box-0"))==null?void 0:n.focus()},50)}async function F(){const e=document.getElementById("login-phone-input").value.trim().replace(/\D/g,"");if(!e||e.length!==10||!/^[6-9]/.test(e)){q("Please enter a valid 10-digit Indian mobile number.");return}b(!0),ae();try{const t=await Oe();await Me(),Ne(t);let n=50;for(;typeof window.sendOtp!="function"&&n>0;)await new Promise(i=>setTimeout(i,100)),n--;if(typeof window.sendOtp!="function")throw new Error("MSG91 SDK not ready. Please refresh and try again.");const o="91"+e;oe=e,window.sendOtp(o,i=>{T=(i==null?void 0:i.reqId)||(i==null?void 0:i.message)||null,De(),b(!1)},i=>{const s=typeof i=="string"?i:(i==null?void 0:i.message)||"Could not send OTP. Please try again.";q(s),b(!1)})}catch(t){q(t.message||"Could not send OTP. Please try again."),b(!1)}}async function P(){const e=He();if(e.length!==z){g("Please enter all 6 digits.");return}if(!T){g("Session expired. Please resend the OTP.");return}h(!0),y(),window.verifyOtp(e,async t=>{try{const n=(t==null?void 0:t.access_token)||(t==null?void 0:t.token)||(t==null?void 0:t.message);if(!n||n.toLowerCase()==="success"){g("Verification error. Please try again."),h(!1);return}const o=await Z(n);h(!1),x(),_(),window.dispatchEvent(new CustomEvent("auth-changed",{detail:{loggedIn:!0,user:o}})),w&&(window.location.href=w);const i=document.getElementById("profile-dropdown-name");if(i){const s=[o.firstName,o.lastName].filter(Boolean).join(" ").trim()||`+91 ${o.phoneNumber}`;i.textContent=s}}catch(n){g(n.message||"Login failed. Please try again."),h(!1)}},t=>{const o=(typeof t=="string"?t:(t==null?void 0:t.message)||"Incorrect OTP. Please try again.").toLowerCase().includes("expired")?"OTP has expired. Please resend.":"Incorrect OTP. Please try again.";g(o);const i=k();i.forEach(s=>{s.classList.add("error"),s.value=""}),i[0]&&i[0].focus(),h(!1)},T)}function Ve(){const e=document.getElementById("login-resend-btn");if(!e.disabled){e.disabled=!0,y(),H();try{const t=window.retryOTP||window.retryOtp;if(typeof t!="function")throw new Error("OTP service is currently unavailable.");t("11",n=>{n!=null&&n.reqId&&(T=n.reqId),re()},n=>{const o=typeof n=="string"?n:(n==null?void 0:n.message)||"Could not resend OTP. Please try again.";g(o),e.disabled=!1})}catch(t){g(t.message||"An error occurred while resending OTP."),e.disabled=!1}}}function re(){x();let e=ie;const t=document.getElementById("login-countdown-num"),n=document.getElementById("login-resend-countdown"),o=document.getElementById("login-resend-btn");!t||!o||(o.disabled=!0,n&&(n.style.display=""),t.textContent=e,L=setInterval(()=>{e--,t.textContent=e,e<=0&&(x(),o.disabled=!1,n&&(n.style.display="none"))},1e3))}function x(){L&&(clearInterval(L),L=null)}function q(e){var n;const t=document.getElementById("login-phone-error");t&&(t.textContent=e),(n=document.getElementById("login-phone-wrap"))==null||n.classList.add("error")}function ae(){var t;const e=document.getElementById("login-phone-error");e&&(e.textContent=""),(t=document.getElementById("login-phone-wrap"))==null||t.classList.remove("error")}function g(e){const t=document.getElementById("login-otp-error");t&&(t.textContent=e)}function y(){const e=document.getElementById("login-otp-error");e&&(e.textContent=""),k().forEach(t=>t.classList.remove("error"))}function b(e){const t=document.getElementById("login-send-otp-btn");t&&(t.disabled=e,t.innerHTML=e?'<span class="login-spinner"></span><span>Sending…</span>':'<span id="login-send-otp-text">Continue</span>')}function h(e){const t=document.getElementById("login-verify-btn");t&&(t.disabled=e,t.innerHTML=e?'<span class="login-spinner"></span><span>Verifying…</span>':'<span id="login-verify-text">Verify OTP</span>')}let w=null;function ut(e=null){let t=null;typeof e=="string"?w=e:e&&typeof e=="object"?(w=e.redirectUrl||null,t=e.context||null):w=null,qe(t);const n=document.getElementById("login-modal-overlay");if(n){if(t==="checkout"){const o=document.getElementById("login-modal-cart-list");if(o)try{const i=localStorage.getItem("kicksaura_cart"),s=i?JSON.parse(i):[];if(s.length===0)o.innerHTML='<p style="color:#888; font-size:14px;">Your cart is empty.</p>';else{o.innerHTML=s.map(l=>{const d=l.productImage&&l.productImage.startsWith("http")?l.productImage:l.productImage?`https://res.cloudinary.com/undefined/image/upload/w_200,h_200,c_fill,q_auto,f_auto/${l.productImage}`:"",c=(l.price*l.quantity).toLocaleString("en-IN");return`
          ...
          `,o.onclick=l=>{const d=document.getElementById("login-modal-cart-summary");d&&(d.style.display=d.style.display==="none"?"block":"none")}}}catch(i){console.error("Failed to load cart for login modal",i)}}se(),n.classList.add("open"),document.body.style.overflow="hidden"}}function _(){x();const e=document.getElementById("login-modal-overlay");e&&(e.classList.remove("open"),document.body.style.overflow="",e.classList.contains("checkout-mode")&&(X()||(window.location.href="/")))}export{Ke as A,Ie as B,R as C,Je as D,Se as E,tt as F,nt as G,he as H,ye as I,ve as J,K,ge as L,Ye as M,ee as N,Xe as O,ut as P,Qe as Q,Te as R,ct as S,Fe as T,ce as a,dt as b,Ge as c,Ze as d,G as e,pt as f,Y as g,me as h,X as i,ne as j,ot as k,Z as l,Pe as m,st as n,We as o,de as p,et as q,at as r,pe as s,fe as t,lt as u,Ue as v,Re as w,it as x,D as y,rt as z};
