import{k as re,m as ce,n as de,j as Y,o as pe,p as Z,q as ue,B as he,C as ye,D as N,A as O,z as W,E as me,F as ge,G as fe,H as ve,y as be,I as we,J as ke,K as xe,L as Ee}from"./login-modal.js_v_1-CRthBa_a.js";/* empty css                     */import{i as Le,a as Ue,o as Se}from"./cart-sidebar-NkVJkWmk.js";import{i as Ie}from"./profile-Cjr88iqr.js";document.getElementById("navbar-container").innerHTML=re("product");document.getElementById("footer-container").innerHTML=ce();de();Y();pe();Le();Z();Ie();ue();Ue();const G=e=>e!=null?"₹"+e.toLocaleString("en-IN"):"";async function Ke(){const d=new URLSearchParams(window.location.search).get("id");if(!d){Q("No product ID specified in the URL.");return}try{const h=await he(d);$e(h)}catch(h){console.error("Failed to load product:",h),Q("Could not load product. Please try again.")}}function Q(e){document.getElementById("product-container").innerHTML=`
    <div style="padding: 80px 20px; text-align: center; grid-column: 1/-1;">
      ...
      <a href="/" style="display:inline-block; margin-top: 16px; color: #c82333; font-weight: 600;">← Back to Home</a>
    </div>`}window.initVideoPlayback=function(e){console.log("[HLS] User requested playback",{video:e.id});const d=window.matchMedia("(pointer: coarse)").matches;if(e.dataset.initialized==="true"){if(d){console.log("[HLS] Mobile: already initialized, deferring to native controls.");return}if(console.log("[HLS] Already initialized. Toggling play/pause."),e.paused){const a=e.play();a!==void 0&&a.catch(n=>console.warn("[HLS] Resume error:",n)),console.log("[HLS] Playback resumed")}else e.pause();return}e.dataset.initialized="true",console.log("[HLS] Initializing");const h=e.dataset.hlsSrc,o=e.dataset.mp4Src;if(e.hlsInstance&&(e.hlsInstance.destroy(),e.hlsInstance=null),e.parentElement&&!e.dataset.listenersAttached){e.dataset.listenersAttached="true";let a=e.parentElement.querySelector(".hls-loader");a||(a=document.createElement("div"),a.className="hls-loader",a.innerHTML='<div style="width:40px;height:40px;border:3px solid rgba(255,255,255,0.3);border-top-color:#fff;border-radius:50%;animation:spin 1s linear infinite;"></div><style>@keyframes spin{100%{transform:rotate(360deg)}}</style>',a.style.cssText="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);z-index:10;pointer-events:none;",e.parentElement.style.position="relative",e.parentElement.appendChild(a)),a.style.display="block";const n=e.parentElement.querySelector(".center-play-btn");n&&(n.style.display="none");const r='<svg width="34" height="34" viewBox="0 0 24 24" fill="white"><polygon points="6,3 21,12 6,21"/></svg>',y='<svg width="30" height="30" viewBox="0 0 24 24" fill="white"><rect x="5" y="3" width="4" height="18" rx="1"/><rect x="15" y="3" width="4" height="18" rx="1"/></svg>',g=(x=0)=>{clearTimeout(n._fadeTimer),n._fadeTimer=setTimeout(()=>{n&&(n.style.opacity="0",n.style.pointerEvents="none")},x)};e.parentElement.addEventListener("mouseleave",()=>{n&&!e.paused&&g(0)}),e.addEventListener("playing",()=>{console.log("[VIDEO UI] playback started"),a.style.display="none",n&&(n.innerHTML=y,n.setAttribute("aria-label","Pause video"),n.style.display="flex",n.style.opacity="1",n.style.pointerEvents="auto",g(600))}),e.addEventListener("mousemove",()=>{n&&!e.paused&&(clearTimeout(n._fadeTimer),n.style.opacity="1",n.style.pointerEvents="auto",g(800))}),e.addEventListener("waiting",()=>{console.log("[HLS] Playback waiting/buffering"),a.style.display="block",n&&(n.style.opacity="0",n.style.pointerEvents="none")}),e.addEventListener("pause",()=>{clearTimeout(n==null?void 0:n._fadeTimer),n&&(n.innerHTML=r,n.setAttribute("aria-label","Play video"),n.style.opacity="1",n.style.pointerEvents="auto",n.style.display="flex"),a.style.display="none"}),e.addEventListener("ended",()=>{clearTimeout(n==null?void 0:n._fadeTimer),n&&(n.innerHTML=r,n.setAttribute("aria-label","Play video"),n.style.opacity="1",n.style.pointerEvents="auto",n.style.display="flex"),a.style.display="none"}),e.addEventListener("error",()=>{a.style.display="none",n&&(n.innerHTML=r,n.style.opacity="1",n.style.pointerEvents="auto",n.style.display="flex")})}else if(e.parentElement){const a=e.parentElement.querySelector(".hls-loader");a&&(a.style.display="block");const n=e.parentElement.querySelector(".center-play-btn");n&&(n.style.display="none")}if(window.Hls&&Hls.isSupported()){const a=new Hls({startLevel:-1,abrEwmaDefaultEstimate:12e5});e.hlsInstance=a,a.on(Hls.Events.MEDIA_ATTACHED,function(){console.log("[HLS] MEDIA_ATTACHED"),console.log("[HLS] Loading source"),a.loadSource(h)}),a.on(Hls.Events.MANIFEST_PARSED,function(){if(console.log("[HLS] MANIFEST_PARSED"),console.log("[HLS] Video ready for playback"),e.paused){const r=e.play();r!==void 0&&r.catch(()=>{})}}),a.on(Hls.Events.ERROR,function(r,y){if(console.error("[HLS] Playback error:",y),y.fatal)if(y.type===Hls.ErrorTypes.NETWORK_ERROR)a.startLoad();else if(y.type===Hls.ErrorTypes.MEDIA_ERROR)a.recoverMediaError();else{console.error("[HLS] Fatal unrecoverable error, falling back to MP4"),a.destroy(),e.hlsInstance=null,e.src=o,e.load();const g=e.play();g!==void 0&&g.catch(x=>console.warn("[HLS] Fallback MP4 error:",x))}}),a.attachMedia(e);const n=e.play();n!==void 0&&n.catch(r=>console.warn("[HLS] Initial synchronous play error (expected):",r))}else if(e.canPlayType("application/vnd.apple.mpegurl")){console.log("[HLS] Native HLS supported (Safari)"),e.src=h,e.load();const a=e.play();a!==void 0&&a.catch(n=>console.warn("[HLS] Native initial play error:",n)),e.addEventListener("loadedmetadata",function(){if(e.paused){const n=e.play();n!==void 0&&n.catch(()=>{})}},{once:!0}),e.addEventListener("error",function(n){console.error("[HLS] Playback error (Native HLS), falling back to MP4",n),e.src=o,e.load();const r=e.play();r!==void 0&&r.catch(y=>console.warn("[HLS] Fallback MP4 error:",y))},{once:!0})}else{console.log("[HLS] No HLS support, falling back to MP4"),e.src=o,e.load();const a=e.play();a!==void 0&&a.catch(n=>console.warn("[HLS] MP4 play error:",n))}};window.centerPlayBtnClick=function(e){console.log("[VIDEO UI] play button clicked");const d=e.parentElement?e.parentElement.querySelector("video"):null;if(d)if(d.dataset.initialized==="true")if(d.paused||d.ended){console.log("[VIDEO UI] video.play() requested (already initialized)");const h=d.play();h!==void 0&&h.then(()=>{console.log("[VIDEO UI] playback started")}).catch(o=>{console.warn("[VIDEO UI] playback failed:",o),e.style.opacity="1",e.style.pointerEvents="auto"})}else console.log("[VIDEO UI] video.pause() requested"),d.pause();else console.log("[VIDEO UI] video.play() requested (triggering init)"),window.initVideoPlayback(d)};function $e(e){var T,P,q,C,A,V,D,_,R,j,F;document.title=`${e.name} — KicksAura`;const d=(((T=e.imageUrls)==null?void 0:T.length)>0?e.imageUrls:[]).map(ye),h=((P=e.videoUrls)==null?void 0:P.length)>0?e.videoUrls:[],o=[...d.map(t=>({type:"image",url:t})),...h.map(t=>({type:"video",url:t}))],a=e.discountedPrice||e.basePrice,n=e.discountedPrice?e.basePrice:null,r=N(e.id);(((q=e.brand)==null?void 0:q.name)||e.brandName||((C=e.category)==null?void 0:C.name)||"KICKS AURA").toUpperCase();const y=n?Math.round((1-a/n)*100):0,g=((A=e.variants)==null?void 0:A.length)>0?e.variants.reduce((t,i)=>t+(i.stockQuantity||0),0):e.stockQuantity??10,x=e.inStockFlag??g>0,J=o.map((t,i)=>{if(t.type==="video"){const s=d.length>0?d[0]:t.url;return`
        ...
        <div class="thumb-item ${i===0?"active":""}" data-idx="${i}">
          <img src="${t.url}" alt="${e.name} ${i+1}" loading="${i===0?"eager":"lazy"}" decoding="async" />
        </div>`}).join("");function X(t){const i=`
      ...
      </button>`;return!o||o.length===0?'<div style="display:flex;align-items:center;justify-content:center;height:100%;font-size:48px;background:transparent;">👟</div>'+i:`
    ...
    `).join("")}
      ...
      ${i}
      ${s}
    `}const E=e.variants&&e.variants.length>0,ee=E?[...e.variants].sort((t,i)=>{const s=parseFloat((t.size||"").replace(/[^0-9.]/g,""))||0,p=parseFloat((i.size||"").replace(/[^0-9.]/g,""))||0;return s-p}):[],te=E?ee.map(t=>`
      ...
      </div>`:"",ie=`https://wa.me/916239379751?text=${encodeURIComponent("I am interested in "+e.name+" - "+window.location.origin+"/product-details?id="+e.id)}`;document.getElementById("product-container").innerHTML=`
    <!-- Left: Gallery -->
    ...
    <div class="product-details">
      ...
      <div class="pd-pricing-section">
        ...
        ${n&&y>0?`<div class="pd-orig-price">${G(n)}</div>`:""}
      </div>
      ...
      <a href="${ie}" target="_blank" rel="noopener noreferrer" class="pd-whatsapp-inquiry-btn">
  ...
  `,ze(e);let f=0;function U(t){f=t;const i=o[f],s=document.getElementById("img-lightbox"),p=document.getElementById("lightbox-content");if(!s||!p||!i)return;const c=document.querySelector(`.main-media-slide[data-idx="${I}"] video`);c&&c.pause(),p.innerHTML=i.type==="video"?`<div style="position: relative; display: flex; align-items: center; justify-content: center; width: 100%; height: 100%;">
           <video 
             poster="${we(i.url)}"
             data-hls-src="${ke(i.url)}"
             data-mp4-src="${xe(i.url)}"
         ...
         </div>`:`<img src="${i.url}" alt="" style="display:block; width:100%; max-height:82vh; object-fit:contain; border-radius:8px; background:transparent;" />`,i.type==="video"&&setTimeout(()=>{const v=p.querySelector("video");v&&window.initVideoPlayback(v)},50);const l=document.getElementById("lb-prev"),m=document.getElementById("lb-next");i.type==="video"?(l&&(l.style.display="none"),m&&(m.style.display="none")):(l&&(l.style.display="",l.style.opacity=f===0?"0.3":"1"),m&&(m.style.display="",m.style.opacity=f===o.length-1?"0.3":"1"));const u=document.getElementById("lb-counter");u&&(u.style.display="none"),s.classList.add("open")}function $(){var i,s;const t=document.getElementById("img-lightbox");t==null||t.classList.remove("open"),(s=(i=document.getElementById("lightbox-content"))==null?void 0:i.querySelector("video"))==null||s.pause()}if(!document.getElementById("img-lightbox")){const t=document.createElement("div");t.id="img-lightbox",t.innerHTML=`
      ...
      </div>`,document.body.appendChild(t),document.getElementById("lightbox-backdrop").addEventListener("click",i=>{i.target===i.currentTarget&&$()}),document.getElementById("lightbox-close").addEventListener("click",$),document.getElementById("lb-prev").addEventListener("click",()=>{f>0&&U(f-1)}),document.getElementById("lb-next").addEventListener("click",()=>{f<o.length-1&&U(f+1)}),document.addEventListener("keydown",i=>{var s;(s=document.getElementById("img-lightbox"))!=null&&s.classList.contains("open")&&(i.key==="Escape"&&$(),i.key==="ArrowLeft"&&f>0&&U(f-1),i.key==="ArrowRight"&&f<o.length-1&&U(f+1))})}const z=e.brand||e.category||"Kicks Aura";if(document.getElementById("size-chart-drawer")){const t=document.getElementById("sc-brand-name");t&&(t.textContent=`Brand : ${z}`)}else{const t=document.createElement("div");t.id="size-chart-drawer",t.innerHTML=`
    ...
    `;const i=document.createElement("div");i.id="size-chart-backdrop",document.body.appendChild(i),document.body.appendChild(t);const s=()=>{t.classList.remove("open"),i.classList.remove("open")};document.getElementById("size-chart-close").addEventListener("click",s),i.addEventListener("click",s)}(V=document.getElementById("size-chart-btn"))==null||V.addEventListener("click",async()=>{const t=document.getElementById("size-chart-drawer"),i=document.getElementById("size-chart-backdrop");if(t&&i){t.classList.add("open"),i.classList.add("open");const s=document.getElementById("size-chart-content"),p={"new balance":{headers:["UK Size","EU Size","Foot Length (cm)"],rows:[["UK 5","38.5","23.5"],["UK 5.5","39","24"],["UK 6","39.5","24.5"],["UK 6.5","40","25"],["UK 7","40.5","25.5"],["UK 7.5","41.5","26"],["UK 8","42","26.5"],["UK 8.5","42.5","27"],["UK 9","43","27.5"],["UK 9.5","44","28"],["UK 10","44.5","28.5"],["UK 10.5","45","29"],["UK 11","45.5","29.5"],["UK 11.5","46.5","30"]]},nike:{headers:["UK Size","EU Size","Foot Length (cm)"],rows:[["UK 5","38","23.5"],["UK 5.5","38.5","24"],["UK 6 (EU 40)","40","24.5"],["UK 6.5","40.5","25"],["UK 7","41","25.4"],["UK 7.5","42","25.8"],["UK 8","42.5","26.2"],["UK 8.5","43","26.7"],["UK 9","44","27.1"],["UK 9.5","44.5","27.5"],["UK 10","45","27.9"],["UK 10.5","45.5","28.3"],["UK 11.5","47","29.2"]]},adidas:{headers:["UK Size","EU Size","Foot Length (cm)"],rows:[["UK 5","38","23.5"],["UK 5.5","38 2/3","24"],["UK 6","39 1/3","24.5"],["UK 6.5","40","25"],["UK 7","40 2/3","25.5"],["UK 7.5","41 1/3","26"],["UK 8","42","26.5"],["UK 8.5","42 2/3","27"],["UK 9","43 1/3","27.5"],["UK 9.5","44","28"],["UK 10","44 2/3","28.5"],["UK 10.5","45 1/3","29"],["UK 11","46","29.5"],["UK 11.5","46 2/3","30"]]},crocs:{headers:["UK Size","EU Size","Foot Length (cm)"],rows:[["UK 5","36-37","23.5"],["UK 5.5","37-38","24"],["UK 6","37-38","24.5"],["UK 6.5","38-39","25"],["UK 7","39-40","25.5"],["UK 7.5","41-42","26"],["UK 8","41-42","26.5"],["UK 8.5","42-43","27"],["UK 9","42-43","27.5"],["UK 9.5","43-44","28"],["UK 10","45-46","28.5"],["UK 10.5","45-46","29"],["UK 11","46-47","29.5"],["UK 11.5","48-49","30"]]},"on cloud":{headers:["UK Size","EU Size","Foot Length (cm)"],rows:[["UK 5","38","23.5"],["UK 5.5","38.5","24"],["UK 6","39","24.5"],["UK 6.5","40","25"],["UK 7","40.5","25.5"],["UK 7.5","41","26"],["UK 8","42","26.5"],["UK 8.5","42.5","27"],["UK 9","43","27.5"],["UK 9.5","44","28"],["UK 10","44.5","28.5"],["UK 10.5","45","29"],["UK 11","46","29.5"],["UK 11.5","47","30"]]},"onitsuka tiger":{headers:["UK Size","EU Size","Foot Length (cm)"],rows:[["UK 5","37.5","23.5"],["UK 5.5","38","24"],["UK 6","39","24.5"],["UK 6.5","39.5","25"],["UK 7","40.5","25.5"],["UK 7.5","41.5","26"],["UK 8","42","26.5"],["UK 8.5","42.5","27"],["UK 9","43.5","27.5"],["UK 9.5","44","28"],["UK 10","44.5","28.5"],["UK 10.5","45","29"],["UK 11","46","29.5"],["UK 11.5","46.5","30"]]}},c=z.toLowerCase(),l=p[c];if(l){const m=l.headers.map(v=>`<th>${v}</th>`).join(""),u=l.rows.map((v,k)=>`<tr class="${k%2===0?"sc-row-even":"sc-row-odd"}">${v.map((B,M)=>`<td class="${M===0?"sc-td-first":""}">${B}</td>`).join("")}</tr>`).join("");s.innerHTML=`
          ...
          </div>`}else{const m=p.nike,u=m.headers.map(k=>`<th>${k}</th>`).join(""),v=m.rows.map((k,B)=>`<tr class="${B%2===0?"sc-row-even":"sc-row-odd"}">${k.map((M,le)=>`<td class="${le===0?"sc-td-first":""}">${M}</td>`).join("")}</tr>`).join("");s.innerHTML=`
          <h3 class="sc-content-title">Foot Measurement</h3>
          <div class="sc-table-wrap">
            <table class="sc-table">
              <thead><tr>${u}</tr></thead>
          ...
          <div class="sc-footer">
            Our dedication to craft means that we are committed to getting the right fit. <a href="https://wa.me/916239379751?text=Hi!%20I%20want%20help%20in%20finding%20my%20right%20size" target="_blank" rel="noopener">Contact us</a> with questions on how to find the right size.
          </div>`}}});let I=0;function ae(){var t;(t=document.getElementById("expand-btn"))==null||t.addEventListener("click",()=>{U(I)})}function se(){var t;(t=document.getElementById("wishlist-detail-btn"))==null||t.addEventListener("click",()=>{var p,c;Ee(e);const i=document.getElementById("wishlist-detail-btn"),s=N(e.id);i==null||i.classList.toggle("active",s),(p=i==null?void 0:i.querySelector("svg"))==null||p.setAttribute("fill",s?"#c82333":"none"),(c=i==null?void 0:i.querySelector("svg"))==null||c.setAttribute("stroke",s?"#c82333":"currentColor"),Z()})}function oe(t){var m;if(t<0||t>=o.length)return;const i=I;I=t,document.querySelectorAll("#thumb-strip .thumb-item").forEach(u=>u.classList.remove("active"));const s=document.querySelector(`#thumb-strip .thumb-item[data-idx="${t}"]`);s&&(s.classList.add("active"),s.scrollIntoView({behavior:"smooth",block:"nearest"}));const p=document.querySelector(`.main-media-slide[data-idx="${t}"]`);if(p){const u=p.querySelector("img[data-src]");u&&(u.src=u.dataset.src,delete u.dataset.src)}[t-1,t+1].forEach(u=>{if(u<0||u>=o.length)return;const v=document.querySelector(`.main-media-slide[data-idx="${u}"]`);if(!v)return;const k=v.querySelector("img[data-src]");k&&(k.src=k.dataset.src,delete k.dataset.src)});const c=document.querySelector(`.main-media-slide[data-idx="${i}"]`);(m=c==null?void 0:c.querySelector("video"))==null||m.pause();const l=document.getElementById("main-media-track");l&&(l.style.transform=`translate3d(-${t*100}%, 0, 0)`)}document.querySelectorAll("#thumb-strip .thumb-item").forEach(t=>{t.addEventListener("click",()=>{oe(parseInt(t.dataset.idx))})});let S=null;document.querySelectorAll(".size-btn:not([disabled])").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".size-btn").forEach(i=>i.classList.remove("selected")),t.classList.add("selected"),S=e.variants.find(i=>String(i.id)===String(t.dataset.variantId))})});function H(){const t=document.querySelector(".size-section");t&&(t.classList.remove("size-shake"),t.offsetWidth,t.classList.add("size-shake"),W("Please select a size first","error"))}let b=1;const K=document.getElementById("qty-value");(D=document.getElementById("qty-minus"))==null||D.addEventListener("click",()=>{b>1&&(b--,K&&(K.textContent=b))}),(_=document.getElementById("qty-plus"))==null||_.addEventListener("click",()=>{b<10&&(b++,K&&(K.textContent=b))}),se(),ae(),(R=document.querySelector(".pd-open-shipping-modal"))==null||R.addEventListener("click",t=>{t.preventDefault(),Se()}),window._pdLiveInterval&&clearInterval(window._pdLiveInterval),window._pdLiveInterval=setInterval(()=>{const t=document.getElementById("pd-viewers-num");if(t){let i=parseInt(t.textContent||"8");const s=Math.random()>.5?1:-1,p=Math.max(8,Math.min(15,i+s));t.textContent=p}},9e3);const w=document.getElementById("live-video-option-box"),L=document.getElementById("live-video-check");w&&L&&(w.addEventListener("click",t=>{t.target!==L&&(L.checked=!L.checked),L.checked?(w.style.borderColor="#2563eb",w.style.background="#eff6ff"):(w.style.borderColor="#e2e8f0",w.style.background="#f8fafc")}),L.addEventListener("change",()=>{L.checked?(w.style.borderColor="#2563eb",w.style.background="#eff6ff"):(w.style.borderColor="#e2e8f0",w.style.background="#f8fafc")})),(j=document.getElementById("add-to-cart-btn"))==null||j.addEventListener("click",()=>{var l;if(E&&!S){H();return}const t=E?S:null,i=((l=document.getElementById("live-video-check"))==null?void 0:l.checked)||!1;O(e,t,b,{liveVideoCall:i});const s=E?` (${t.size})`:"",p=b>1?` × ${b}`:"",c=i?" (Live Video Call Requested)":"";W(`${e.name}${s}${p} added to cart!${c}`,"success"),Y()}),(F=document.getElementById("buy-now-btn"))==null||F.addEventListener("click",()=>{var s;if(E&&!S){H();return}const t=E?S:null,i=((s=document.getElementById("live-video-check"))==null?void 0:s.checked)||!1;O(e,t,b,{liveVideoCall:i}),sessionStorage.setItem("checkout_intent","true"),window.location.href="/checkout"})}async function ze(e){var a,n;const d=((a=e.category)==null?void 0:a.name)||e.category||e.brandName||null;if(!d)return;const h=document.querySelector("main.product-page");if(!h)return;(n=document.getElementById("related-products-section"))==null||n.remove();const o=document.createElement("section");o.id="related-products-section",o.className="related-products-section",o.innerHTML=`
