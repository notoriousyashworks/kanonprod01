    ...
    <a href="/product-details?id=${e.id}" target="_blank" class="product-card-link" aria-label="${e.name}">
      <article class="product-card product-card-new ${c?"is-handbag":""}" data-product-id="${e.id}">
        <div class="pc-image-wrap">
          ${d}
          <button class="pc-heart-btn ${r?"active":""}" onclick="event.preventDefault(); event.stopPropagation(); toggleWishlistItem('${e.id}'); this.classList.toggle('active'); this.querySelector('svg').setAttribute('fill', this.classList.contains('active') ? '#0a0a0a' : 'none'); this.querySelector('svg').setAttribute('stroke', this.classList.contains('active') ? '#0a0a0a' : 'currentColor')">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="${r?"#0a0a0a":"none"}" stroke="${r?"#0a0a0a":"currentColor"}" stroke-width="2">
...
Link: `+window.location.origin+"/product-details?id="+e.id)}" target="_blank" rel="noopener noreferrer" class="pc-whatsapp-btn" aria-label="Inquire via WhatsApp" onclick="event.stopPropagation();">
  ...
  `,!document.getElementById("policy-modal-overlay")){const a=document.createElement("div");a.id="policy-modal-overlay",a.className="login-modal-overlay",a.style.zIndex="99999",a.innerHTML=`
    ...
    `,document.body.appendChild(a),document.getElementById("policy-modal-close").addEventListener("click",()=>{document.getElementById("policy-modal-overlay").classList.remove("open")}),a.addEventListener("click",r=>{r.target===a&&a.classList.remove("open")})}qe();const i=document.getElementById("login-about-link");i&&(i.onclick=a=>{a.preventDefault(),document.getElementById("policy-modal-title").textContent="About Us",document.getElementById("policy-modal-content").innerHTML=ce,document.getElementById("policy-modal-overlay").classList.add("open")});const s=document.getElementById("login-shipping-link");s&&(s.onclick=a=>{a.preventDefault(),document.getElementById("policy-modal-title").textContent="Shipping & Delivery Policy",document.getElementById("policy-modal-content").innerHTML=pe,document.getElementById("policy-modal-overlay").classList.add("open")})}function qe(){document.getElementById("login-modal-close").addEventListener("click",L),document.getElementById("login-modal-overlay").addEventListener("click",n=>{n.target===document.getElementById("login-modal-overlay")&&L()}),document.addEventListener("keydown",n=>{n.key==="Escape"&&L()}),document.getElementById("login-send-otp-btn").addEventListener("click",W);const e=document.getElementById("login-phone-input");function t(){const n=document.getElementById("login-phone-display");if(!n)return;const o=e.value.replace(/\D/g,"").slice(0,10);let i="";for(let s=0;s<10;s++){const a=o[s]||"",r=s===o.length,l=s===4?"margin-right: 12px;":"",c=r&&document.activeElement===e?"border-bottom: 2px solid #0f172a;":"border-bottom: 2px solid #cbd5e1;";i+=`<span style="width: 14px; height: 28px; display: inline-flex; justify-content: center; align-items: center; font-size: 18px; font-weight: 600; color: ${a?"#0f172a":"transparent"}; ${c} ${l} transition: all 0.2s;">${a||"0"}</span>`}n.innerHTML=i}e.addEventListener("keydown",n=>{n.key==="Enter"&&W()}),e.addEventListener("input",n=>{let o=n.target.value.replace(/\D/g,"");o.length>10&&(o=o.slice(0,10)),n.target.value=o,t(),re()}),e.addEventListener("focus",t),e.addEventListener("blur",t),t(),je(),document.getElementById("login-verify-btn").addEventListener("click",P),document.getElementById("login-resend-btn").addEventListener("click",De),document.getElementById("login-change-phone-btn").addEventListener("click",()=>{se()})}function je(){const e=x();e.forEach((t,n)=>{t.addEventListener("input",o=>{const i=o.target.value.replace(/\D/g,"");o.target.value=i.slice(-1),i?(t.classList.add("filled"),t.classList.remove("error"),n<e.length-1?e[n+1].focus():Array.from(e).every(a=>a.value)&&P()):t.classList.remove("filled"),h()}),t.addEventListener("keydown",o=>{o.key==="Backspace"?!t.value&&n>0&&(e[n-1].value="",e[n-1].classList.remove("filled"),e[n-1].focus()):o.key==="Enter"&&P()}),t.addEventListener("paste",o=>{o.preventDefault();const i=(o.clipboardData||window.clipboardData).getData("text").replace(/\D/g,"");if(!i)return;e.forEach((a,r)=>{a.value=i[r]||"",i[r]?a.classList.add("filled"):a.classList.remove("filled")});const s=e.findIndex(a=>!a.value);s===-1?(e[e.length-1].focus(),P()):e[s].focus(),h()})})}function x(){return Array.from({length:z},(e,t)=>document.getElementById(`otp-box-${t}`))}function ze(){return x().map(e=>e.value).join("")}function H(){x().forEach(e=>{e.value="",e.classList.remove("filled","error")})}function se(){w(),document.getElementById("login-step-phone").style.display="",document.getElementById("login-step-otp").style.display="none";const e=document.getElementById("login-modal-title"),t=document.getElementById("login-modal-subtitle");e&&(e.textContent="Log In"),t&&(t.textContent="Enter your mobile number to continue");const n=document.getElementById("login-phone-input");n&&(n.value=""),H(),h(),v(!1),setTimeout(()=>{var o;return(o=document.getElementById("login-phone-input"))==null?void 0:o.focus()},50)}function He(){document.getElementById("login-step-phone").style.display="none",document.getElementById("login-step-otp").style.display="";const e=document.getElementById("login-modal-title"),t=document.getElementById("login-modal-subtitle");e&&(e.textContent="Enter OTP"),t&&(t.textContent="Check your SMS"),document.getElementById("login-otp-phone-display").textContent=`+91 ${oe}`,H(),h(),m(!1),ae(),setTimeout(()=>{var n;return(n=document.getElementById("otp-box-0"))==null?void 0:n.focus()},50)}async function W(){const e=document.getElementById("login-phone-input").value.trim().replace(/\D/g,"");if(!e||e.length!==10||!/^[6-9]/.test(e)){q("Please enter a valid 10-digit Indian mobile number.");return}v(!0),re();try{const t=await $e();await Oe(),Me(t);let n=50;for(;typeof window.sendOtp!="function"&&n>0;)await new Promise(i=>setTimeout(i,100)),n--;if(typeof window.sendOtp!="function")throw new Error("MSG91 SDK not ready. Please refresh and try again.");const o="91"+e;oe=e,window.sendOtp(o,i=>{A=(i==null?void 0:i.reqId)||(i==null?void 0:i.message)||null,He(),v(!1)},i=>{const s=typeof i=="string"?i:(i==null?void 0:i.message)||"Could not send OTP. Please try again.";q(s),v(!1)})}catch(t){q(t.message||"Could not send OTP. Please try again."),v(!1)}}async function P(){const e=ze();if(e.length!==z){f("Please enter all 6 digits.");return}if(!A){f("Session expired. Please resend the OTP.");return}m(!0),h(),window.verifyOtp(e,async t=>{try{const n=(t==null?void 0:t.access_token)||(t==null?void 0:t.token)||(t==null?void 0:t.message);if(!n||n.toLowerCase()==="success"){f("Verification error. Please try again."),m(!1);return}const o=await Z(n);m(!1),w(),L(),window.dispatchEvent(new CustomEvent("auth-changed",{detail:{loggedIn:!0,user:o}})),b&&(window.location.href=b);const i=document.getElementById("profile-dropdown-name");if(i){const s=[o.firstName,o.lastName].filter(Boolean).join(" ").trim()||`+91 ${o.phoneNumber}`;i.textContent=s}}catch(n){f(n.message||"Login failed. Please try again."),m(!1)}},t=>{const o=(typeof t=="string"?t:(t==null?void 0:t.message)||"Incorrect OTP. Please try again.").toLowerCase().includes("expired")?"OTP has expired. Please resend.":"Incorrect OTP. Please try again.";f(o);const i=x();i.forEach(s=>{s.classList.add("error"),s.value=""}),i[0]&&i[0].focus(),m(!1)},A)}function De(){const e=document.getElementById("login-resend-btn");if(!e.disabled){e.disabled=!0,h(),H();try{const t=window.retryOTP||window.retryOtp;if(typeof t!="function")throw new Error("OTP service is currently unavailable.");t("11",n=>{n!=null&&n.reqId&&(A=n.reqId),ae()},n=>{const o=typeof n=="string"?n:(n==null?void 0:n.message)||"Could not resend OTP. Please try again.";f(o),e.disabled=!1})}catch(t){f(t.message||"An error occurred while resending OTP."),e.disabled=!1}}}function ae(){w();let e=ie;const t=document.getElementById("login-countdown-num"),n=document.getElementById("login-resend-countdown"),o=document.getElementById("login-resend-btn");!t||!o||(o.disabled=!0,n&&(n.style.display=""),t.textContent=e,C=setInterval(()=>{e--,t.textContent=e,e<=0&&(w(),o.disabled=!1,n&&(n.style.display="none"))},1e3))}function w(){C&&(clearInterval(C),C=null)}function q(e){var n;const t=document.getElementById("login-phone-error");t&&(t.textContent=e),(n=document.getElementById("login-phone-wrap"))==null||n.classList.add("error")}function re(){var t;const e=document.getElementById("login-phone-error");e&&(e.textContent=""),(t=document.getElementById("login-phone-wrap"))==null||t.classList.remove("error")}function f(e){const t=document.getElementById("login-otp-error");t&&(t.textContent=e)}function h(){const e=document.getElementById("login-otp-error");e&&(e.textContent=""),x().forEach(t=>t.classList.remove("error"))}function v(e){const t=document.getElementById("login-send-otp-btn");t&&(t.disabled=e,t.innerHTML=e?'<span class="login-spinner"></span><span>Sending…</span>':'<span id="login-send-otp-text">Continue</span>')}function m(e){const t=document.getElementById("login-verify-btn");t&&(t.disabled=e,t.innerHTML=e?'<span class="login-spinner"></span><span>Verifying…</span>':'<span id="login-verify-text">Verify OTP</span>')}let b=null;function ft(e=null){let t=null;typeof e=="string"?b=e:e&&typeof e=="object"?(b=e.redirectUrl||null,t=e.context||null):b=null,Ne(t);const n=document.getElementById("login-modal-overlay");if(n){if(t==="checkout"){const o=document.getElementById("login-modal-cart-list");if(o)try{const i=localStorage.getItem("kicksaura_cart"),s=i?JSON.parse(i):[];if(s.length===0)o.innerHTML='<p style="color:#888; font-size:14px;">Your cart is empty.</p>';else{o.innerHTML=s.map(l=>{const d=l.productImage&&l.productImage.startsWith("http")?l.productImage:l.productImage?`https://res.cloudinary.com/undefined/image/upload/w_200,h_200,c_fill,q_auto,f_auto/${l.productImage}`:"",c=(l.price*l.quantity).toLocaleString("en-IN");return`
          ...
          `,o.onclick=l=>{const d=document.getElementById("login-modal-cart-summary");d&&(d.style.display=d.style.display==="none"?"block":"none")}}}catch(i){console.error("Failed to load cart for login modal",i)}}se(),n.classList.add("open"),document.body.style.overflow="hidden"}}function L(){w();const e=document.getElementById("login-modal-overlay");e&&(e.classList.remove("open"),document.body.style.overflow="",e.classList.contains("checkout-mode")&&(X()||(window.location.href="/")))}export{lt as A,Je as B,Ee as C,F as D,Ie as E,it as F,ot as G,Ye as H,me as I,he as J,ye as K,K as L,Ke as M,We as N,Ge as O,ee as P,et as Q,ft as R,Xe as S,Ae as T,ut as U,Ue as V,ce as a,pt as b,Qe as c,tt as d,G as e,gt as f,Y as g,fe as h,X as i,ne as j,at as k,Z as l,Pe as m,rt as n,Ve as o,de as p,nt as q,dt as r,pe as s,Ze as t,ct as u,ge as v,Re as w,Fe as x,st as y,D as z};
