import{k as re,m as ce,n as de,j as Y,o as pe,p as Z,q as ue,A as he,B as ye,C as N,z as O,y as W,D as me,E as ge,F as fe,G as ve,x as be,H as we,I as ke,J as xe,K as Ee}from"./login-modal.js_v_1-YkX-reF-.js";/* empty css                     */import{i as Le,a as Ue,o as Se}from"./cart-sidebar-DjxeW8cT.js";import{i as Ie}from"./profile-BtTw_Xe_.js";document.getElementById("navbar-container").innerHTML=re("product");document.getElementById("footer-container").innerHTML=ce();de();Y();pe();Le();Z();Ie();ue();Ue();const G=e=>e!=null?"₹"+e.toLocaleString("en-IN"):"";async function Ke(){const d=new URLSearchParams(window.location.search).get("id");if(!d){Q("No product ID specified in the URL.");return}try{const h=await he(d);$e(h)}catch(h){console.error("Failed to load product:",h),Q("Could not load product. Please try again.")}}function Q(e){document.getElementById("product-container").innerHTML=`
