...
`,ue="/api/v1";async function u(e,t={}){const n=`${ue}${e}`,i={headers:{"Content-Type":"application/json",...t.headers},credentials:"include",...t};try{const o=await fetch(n,i);if(!o.ok){if(o.status===401)throw console.warn("Session expired or unauthorized. Logging out..."),ee(),new Error("Session expired. Please log in again.");const s=await o.json().catch(()=>({}));throw new Error(s.error||`Request failed with status ${o.status}`)}return o.status===204?null:await o.json()}catch(o){throw console.error(`API Error [${e}]:`,o),o}}async function ge(){return u("/categories")}async function Ue(){const e=await u("/products");return e.content||e}async function Fe(){const e=await u("/products/new-arrivals");return e.content||e}async function Re(){const e=await u("/products/trending");return e.content||e}async function Ke(e,t=0,n=16){const i=new URLSearchParams;e.query&&i.append("query",e.query),e.categories&&e.categories.length>0&&i.append("categories",e.categories.join(",")),e.brands&&e.brands.length>0&&i.append("brands",e.brands.join(",")),e.minPrice!==void 0&&e.minPrice>0&&i.append("minPrice",e.minPrice),e.maxPrice!==void 0&&e.maxPrice<35e3&&i.append("maxPrice",e.maxPrice),e.sizes&&e.sizes.length>0&&i.append("sizes",e.sizes.join(",")),i.append("page",t),i.append("size",n);const s=`/products/filter?${i.toString()}`;return u(s)}async function Je(e){return u(`/products/${e}`)}async function Ye(e,t,n=8){const i=await u(`/products/category/${encodeURIComponent(e)}`),s=(i.content||i).filter(a=>String(a.id)!==String(t));for(let a=s.length-1;a>0;a--){const r=Math.floor(Math.random()*(a+1));[s[a],s[r]]=[s[r],s[a]]}return s.slice(0,n)}async function Ge(){return u("/brands")}async function Qe(e){return u("/orders/checkout",{method:"POST",body:JSON.stringify(e)})}async function Ze(e){return u(`/orders/user/${e}?t=${Date.now()}`)}async function Xe(){return u("/reviews")}async function et(e){return u("/users/profile",{method:"PUT",body:JSON.stringify(e)})}async function tt(e){return u("/users/profile/address",{method:"POST",body:JSON.stringify(e)})}function D(e,t="info"){let n=document.querySelector(".toast-container");n||(n=document.createElement("div"),n.className="toast-container",document.body.appendChild(n));const i=n.querySelectorAll(".toast");for(let s of i)if(s.textContent===e)return;const o=document.createElement("div");o.className=`toast toast--${t}`,o.textContent=e,n.appendChild(o),setTimeout(()=>{o.remove()},3e3)}function nt(){const e=document.getElementById("nav-search-input"),t=document.getElementById("nav-search-btn"),n=()=>{e&&e.value.trim()&&(window.location.href=`/products?search=${encodeURIComponent(e.value.trim())}`)};e&&e.addEventListener("keydown",a=>{a.key==="Enter"&&n()}),t&&t.addEventListener("click",n);const i=document.getElementById("nav-animated-placeholder"),o=document.getElementById("placeholder-text-1"),s=document.getElementById("placeholder-text-2");if(e&&i&&o&&s){const a=["Search for Sneakers...","Search for Apparel...","Search for Perfumes...","Search for Watches...","Search for Nike Pandas...","Search for Adidas Sambas...","Search for New Balance 9060...","Search for Air Force 1...","Search for Onitsuka Tiger...","Search for Air Jordan 1...","Search for Sunglasses...","Search for Nike Dunks...","Search for Adidas Campus...","Search for Belts...","Search for New Balance 530...","Search for Air Jordan 4...","Search for Adidas Spezial...","Search for Nike Vomero...","Search for Wallets...","Search for ASICS Gel-NYC...","Search for Nike P-6000...","Search for New Balance 550...","Search for Travis Scott...","Search for Accessories...","Search for Yeezy 350..."];let r=0,l=0,d=!1,c=null;const p=()=>{const M=a[r];d?(o.textContent=M.substring(0,l-1),l--):(o.textContent=M.substring(0,l+1),l++);let N=d?30:60;!d&&l===M.length?(N=2e3,d=!0):d&&l===0&&(d=!1,r=(r+1)%a.length,N=500),c=setTimeout(p,N)},E=()=>{c||(s&&(s.style.display="none"),o.className="animated-placeholder-text visible",c=setTimeout(p,500))},I=()=>{c&&(clearTimeout(c),c=null)},m=()=>{document.activeElement===e||e.value.trim()!==""?(i.style.display="none",I()):(i.style.display="flex",E())};e.addEventListener("focus",m),e.addEventListener("blur",m),e.addEventListener("input",m),m()}}function fe(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.includes("/upload/")&&!e.includes("/f_auto")?e.replace("/upload/","/upload/f_auto,q_auto,w_800/"):e}function me(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/so_0,w_800,q_auto/f_jpg/")}function he(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/sp_auto:maxres_720p/").replace(/\.mp4$/i,".m3u8")}function ye(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/q_auto,vc_h264,w_800/")}function ve(e){return!e||typeof e!="string"||!e.includes("res.cloudinary.com")?e:e.replace("/upload/","/upload/q_auto,vc_h264,w_400/")}function g(e){return typeof e=="string"&&e.includes("ik.imagekit.io")}function be(e){return!g(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=q-auto,f-auto,w-800"}function we(e){return!g(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=orig"}function xe(e){return!g(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=orig"}function ke(e){return!g(e)||e.includes("tr=")||e.includes("/tr:")?e:e+(e.includes("?")?"&":"?")+"tr=orig"}function Ee(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?fe(e):g(e)?be(e):e}function Ie(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?me(e):g(e)?we(e):e.includes(".b-cdn.net")&&e.includes(".m3u8")?e.replace("playlist.m3u8","thumbnail.jpg"):e}function ot(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?he(e):(g(e)||e.includes(".b-cdn.net")&&e.includes(".m3u8"),e)}function it(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?ye(e):g(e)?xe(e):e.includes(".b-cdn.net")&&e.includes(".m3u8")?e.replace("playlist.m3u8","play_720p.mp4"):e}function Se(e){return!e||typeof e!="string"?e:e.includes("res.cloudinary.com")?ve(e):g(e)?ke(e):e.includes(".b-cdn.net")&&e.includes(".m3u8")?e.replace("playlist.m3u8","play_480p.mp4"):e}function Ce(e,t){const n="916239379751",i=`I am interested in ${e} - ${window.location.origin}/product-details?id=${t}`,o=`https://wa.me/${n}?text=${encodeURIComponent(i)}`;window.open(o,"_blank","noopener,noreferrer")}typeof window<"u"&&(window.openProductWhatsApp=Ce);function st(e){var E,I;const t=Ee(((E=e.imageUrls)==null?void 0:E[0])||""),i=((I=e.videoUrls)==null?void 0:I.length)>0?e.videoUrls[0]:null,o=m=>"₹"+m.toLocaleString("en-IN"),s=e.discountedPrice||e.basePrice,a=e.discountedPrice?e.basePrice:null,r=R(e.id);let l="";t?l=`<img src="${t}" alt="${e.name}" loading="lazy" />`:i?l=`<video 
  ...
  `}function at(e="home"){return setTimeout(()=>te(),0),`
    <header class="header">
      <!-- Top Promo Bar -->
