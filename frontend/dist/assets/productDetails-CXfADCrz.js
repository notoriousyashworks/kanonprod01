import{k as re,m as ce,n as de,j as Y,o as pe,p as Z,q as ue,B as he,C as ye,D as N,A as O,z as W,E as me,F as ge,G as ve,H as fe,y as be,I as we,J as ke,K as xe,L as Ee}from"./login-modal.js_v_1-BRTwoa-Z.js";/* empty css                     */import{i as Le,a as Ue,o as Se}from"./cart-sidebar-DDj1jOll.js";import{i as Ie}from"./profile-PccgHn7L.js";document.getElementById("navbar-container").innerHTML=re("product");document.getElementById("footer-container").innerHTML=ce();de();Y();pe();Le();Z();Ie();ue();Ue();const G=e=>e!=null?"₹"+e.toLocaleString("en-IN"):"";async function Ke(){const d=new URLSearchParams(window.location.search).get("id");if(!d){Q("No product ID specified in the URL.");return}try{const h=await he(d);$e(h)}catch(h){console.error("Failed to load product:",h),Q("Could not load product. Please try again.")}}function Q(e){document.getElementById("product-container").innerHTML=`
