...
function renderProduct(product) {
  ...
  document.getElementById('product-container').innerHTML = `
    ...
    <div class="product-details">
      ...
      <a href="https://wa.me/916239379751?text=\${encodeURIComponent('I am interested in ' + product.name + ' - ' + window.location.origin + '/product-details?id=' + product.id)}" target="_blank" rel="noopener noreferrer" class="pd-whatsapp-inquiry-btn">
